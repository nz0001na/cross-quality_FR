...
src = 'F:\zn1\znMCM\MsCeleb1M_code\code_deep_fr\face_recognition_result\Facescrub_dataset\VGGface\0220_V2_MidvsHigh\';
curvedata = csvread([src 'listcmck.csv']); 

plot(curvedata(1:50,1),curvedata(1:50,2),'LineWidth',2);
xlabel('Rank');
ylabel('Recognition Rate(%)');
title('Middle vs High Quality Faces using CenterLoss features','FontSize',15);
...
%marked points
csvwrite([src 'remarked_cmck.csv'], marklist);
