...
title('Low vs Middle Quality Faces using IJB-A Gabor features','FontSize',15);
...
marklist(1,2) = cmc1;
plot(1,cmc1,'r*');
text(1,cmc1,['(' num2str(1) ', ' num2str(cmc1) ')'],'FontSize',15);

cmc5 = curvedata(find(curvedata(:,1)==5),2);
marklist(2,1) = 5;
marklist(2,2) = cmc5;
plot(5,cmc5,'r*');
text(5,cmc5,['(' num2str(5) ', ' num2str(cmc5) ')'],'FontSize',15);

cmc10 = curvedata(find(curvedata(:,1)==10),2);
marklist(3,1) = 10;
marklist(3,2) = cmc10;
plot(10,cmc10,'r*');
text(10,cmc10,['(' num2str(10) ', ' num2str(cmc10) ')'],'FontSize',15);

cmc20 = curvedata(find(curvedata(:,1)==20),2);
marklist(4,1) = 20;
marklist(4,2) = cmc20;
plot(20,cmc20,'r*');
text(20,cmc20,['(' num2str(20) ', ' num2str(cmc20) ')'],'FontSize',15);

cmc30 = curvedata(find(curvedata(:,1)==30),2);
marklist(5,1) = 30;
marklist(5,2) = cmc30;
plot(30,cmc30,'r*');
text(30,cmc30,['(' num2str(30) ', ' num2str(cmc30) ')'],'FontSize',15);

cmc50 = curvedata(find(curvedata(:,1)==50),2);
marklist(6,1) = 50;
marklist(6,2) = cmc50;
plot(50,cmc50,'r*');
text(50,cmc50,['(' num2str(50) ', ' num2str(cmc50) ')'],'FontSize',15);
